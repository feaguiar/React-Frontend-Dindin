    ...
    <div className='container-sign-in'>
      ...
      <div className='content-sign-in'>
        <div className='left'>
          ...
          <h3>Organizar as suas finanças nunca foi tão fácil, com o DINDIN, você tem tudo num único lugar e em um clique de distância.</h3>
        ...
        <div className='right'>
          <form onSubmit={handleSubmit}>
            ...
            <div className='container-inputs '>
              <label className='container-label' htmlFor='password'>Password</label>
